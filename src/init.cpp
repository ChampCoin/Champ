    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Champcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  champcoind [options]                     " + "\n" +
                  "  champcoind [options] <command> [params]  " + _("Send command to -server or champcoind") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 38173 or testnet: 39173)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 38172 or testnet: 39172)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Champcoin Wiki for SSL setup instructions)") + "\n" +
